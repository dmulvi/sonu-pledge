const abi = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "mintingPhase", type: "uint256" },
          ...
          { internalType: "bool", name: "numberedMetadata", type: "bool" },
        ],
        internalType: "struct SonuStreamPledge.InitArgs",
        name: "_init",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [{ internalType: "bool", name: "_numbered", type: "bool" }],
    name: "setNumberedMetadata",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
